...
*/
$section1 = $word->AddSection();
$section1->addText("EMPRESA COMERCIAL S.A.",array("size"=>22,"bold"=>true,"align"=>"right"));
$section1->addText("CALLE 17 # 105-12",array("size"=>12,"bold"=>true,"align"=>"right"));
$section1->addText("FONTIBON",array("size"=>12,"bold"=>true,"align"=>"right"));
$section1->addText("TEL (844) 485.3300 / 485.1020",array("size"=>12,"bold"=>true,"align"=>"right"));
$section1->addText("CODIGO POSTAL 061009",array("size"=>12,"bold"=>true,"align"=>"right"));
$section1->addText("www.empresa.com",array("size"=>12,"bold"=>true,"align"=>"right"));
$section1->addText();
